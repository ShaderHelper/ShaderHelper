...
#define FBXSDK_SHADING_LANGUAGE_OPBR    "OpenPbrSL"
...
// These two hints are only relevant for the FBXSDK_SHADING_LANGUAGE_SSSL and FBXSDK_SHADING_LANGUAGE_OPBR
...
#define FBXSDK_IMPLEMENTATION_OPBR      "ImplementationOPBR"
