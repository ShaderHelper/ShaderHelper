Swizzle<4, T, Vector2Impl, 0, 0> xx;
Swizzle<4, T, Vector2Impl, 0, 1> xy;
Swizzle<4, T, Vector2Impl, 0, 2> xz;
Swizzle<4, T, Vector2Impl, 0, 3> xw;
Swizzle<4, T, Vector2Impl, 1, 0> yx;
Swizzle<4, T, Vector2Impl, 1, 1> yy;
Swizzle<4, T, Vector2Impl, 1, 2> yz;
Swizzle<4, T, Vector2Impl, 1, 3> yw;
Swizzle<4, T, Vector2Impl, 2, 0> zx;
Swizzle<4, T, Vector2Impl, 2, 1> zy;
Swizzle<4, T, Vector2Impl, 2, 2> zz;
Swizzle<4, T, Vector2Impl, 2, 3> zw;
Swizzle<4, T, Vector2Impl, 3, 0> wx;
Swizzle<4, T, Vector2Impl, 3, 1> wy;
Swizzle<4, T, Vector2Impl, 3, 2> wz;
Swizzle<4, T, Vector2Impl, 3, 3> ww;

Swizzle<4, T, VectorImpl, 0, 0, 0> xxx;
Swizzle<4, T, VectorImpl, 0, 0, 1> xxy;
Swizzle<4, T, VectorImpl, 0, 0, 2> xxz;
Swizzle<4, T, VectorImpl, 0, 0, 3> xxw;
Swizzle<4, T, VectorImpl, 0, 1, 0> xyx;
Swizzle<4, T, VectorImpl, 0, 1, 1> xyy;
Swizzle<4, T, VectorImpl, 0, 1, 2> xyz;
Swizzle<4, T, VectorImpl, 0, 1, 3> xyw;
Swizzle<4, T, VectorImpl, 0, 2, 0> xzx;
Swizzle<4, T, VectorImpl, 0, 2, 1> xzy;
Swizzle<4, T, VectorImpl, 0, 2, 2> xzz;
Swizzle<4, T, VectorImpl, 0, 2, 3> xzw;
Swizzle<4, T, VectorImpl, 0, 3, 0> xwx;
Swizzle<4, T, VectorImpl, 0, 3, 1> xwy;
Swizzle<4, T, VectorImpl, 0, 3, 2> xwz;
Swizzle<4, T, VectorImpl, 0, 3, 3> xww;
Swizzle<4, T, VectorImpl, 1, 0, 0> yxx;
Swizzle<4, T, VectorImpl, 1, 0, 1> yxy;
Swizzle<4, T, VectorImpl, 1, 0, 2> yxz;
Swizzle<4, T, VectorImpl, 1, 0, 3> yxw;
Swizzle<4, T, VectorImpl, 1, 1, 0> yyx;
Swizzle<4, T, VectorImpl, 1, 1, 1> yyy;
Swizzle<4, T, VectorImpl, 1, 1, 2> yyz;
Swizzle<4, T, VectorImpl, 1, 1, 3> yyw;
Swizzle<4, T, VectorImpl, 1, 2, 0> yzx;
Swizzle<4, T, VectorImpl, 1, 2, 1> yzy;
Swizzle<4, T, VectorImpl, 1, 2, 2> yzz;
Swizzle<4, T, VectorImpl, 1, 2, 3> yzw;
Swizzle<4, T, VectorImpl, 1, 3, 0> ywx;
Swizzle<4, T, VectorImpl, 1, 3, 1> ywy;
Swizzle<4, T, VectorImpl, 1, 3, 2> ywz;
Swizzle<4, T, VectorImpl, 1, 3, 3> yww;
Swizzle<4, T, VectorImpl, 2, 0, 0> zxx;
Swizzle<4, T, VectorImpl, 2, 0, 1> zxy;
Swizzle<4, T, VectorImpl, 2, 0, 2> zxz;
Swizzle<4, T, VectorImpl, 2, 0, 3> zxw;
Swizzle<4, T, VectorImpl, 2, 1, 0> zyx;
Swizzle<4, T, VectorImpl, 2, 1, 1> zyy;
Swizzle<4, T, VectorImpl, 2, 1, 2> zyz;
Swizzle<4, T, VectorImpl, 2, 1, 3> zyw;
Swizzle<4, T, VectorImpl, 2, 2, 0> zzx;
Swizzle<4, T, VectorImpl, 2, 2, 1> zzy;
Swizzle<4, T, VectorImpl, 2, 2, 2> zzz;
Swizzle<4, T, VectorImpl, 2, 2, 3> zzw;
Swizzle<4, T, VectorImpl, 2, 3, 0> zwx;
Swizzle<4, T, VectorImpl, 2, 3, 1> zwy;
Swizzle<4, T, VectorImpl, 2, 3, 2> zwz;
Swizzle<4, T, VectorImpl, 2, 3, 3> zww;
Swizzle<4, T, VectorImpl, 3, 0, 0> wxx;
Swizzle<4, T, VectorImpl, 3, 0, 1> wxy;
Swizzle<4, T, VectorImpl, 3, 0, 2> wxz;
Swizzle<4, T, VectorImpl, 3, 0, 3> wxw;
Swizzle<4, T, VectorImpl, 3, 1, 0> wyx;
Swizzle<4, T, VectorImpl, 3, 1, 1> wyy;
Swizzle<4, T, VectorImpl, 3, 1, 2> wyz;
Swizzle<4, T, VectorImpl, 3, 1, 3> wyw;
Swizzle<4, T, VectorImpl, 3, 2, 0> wzx;
Swizzle<4, T, VectorImpl, 3, 2, 1> wzy;
Swizzle<4, T, VectorImpl, 3, 2, 2> wzz;
Swizzle<4, T, VectorImpl, 3, 2, 3> wzw;
Swizzle<4, T, VectorImpl, 3, 3, 0> wwx;
Swizzle<4, T, VectorImpl, 3, 3, 1> wwy;
Swizzle<4, T, VectorImpl, 3, 3, 2> wwz;
Swizzle<4, T, VectorImpl, 3, 3, 3> www;
