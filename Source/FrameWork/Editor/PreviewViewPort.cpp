...
namespace FW
{
	uint32 MapTextureFormatToGLInternalFormat(GpuFormat InTexFormat)
	{
		switch (InTexFormat)
		{
		case GpuFormat::R8_UNORM:              return 0x8229; // GL_R8
		case GpuFormat::R8G8B8A8_UNORM:        return 0x8058; // GL_RGBA8
		case GpuFormat::B8G8R8A8_UNORM:        return 0x8058; // GL_RGBA8
		case GpuFormat::B8G8R8A8_UNORM_SRGB:   return 0x8C43; // GL_SRGB8_ALPHA8
		case GpuFormat::R10G10B10A2_UNORM:     return 0x8059; // GL_RGB10_A2
		case GpuFormat::R16G16B16A16_UNORM:    return 0x805B; // GL_RGBA16
		case GpuFormat::R16G16B16A16_UINT:     return 0x8D76; // GL_RGBA16UI
		case GpuFormat::R32G32B32A32_UINT:     return 0x8D70; // GL_RGBA32UI
		case GpuFormat::R16G16B16A16_FLOAT:    return 0x881A; // GL_RGBA16F
		case GpuFormat::R32G32B32A32_FLOAT:    return 0x8814; // GL_RGBA32F
		case GpuFormat::R11G11B10_FLOAT:       return 0x8C3A; // GL_R11F_G11F_B10F
		case GpuFormat::R16_FLOAT:             return 0x822D; // GL_R16F
		case GpuFormat::R32_FLOAT:             return 0x822E; // GL_R32F
		default:
			AUX::Unreachable();
		}
	}

	bool IsBGRFormat(GpuFormat InTexFormat)
	{
		return InTexFormat == GpuFormat::B8G8R8A8_UNORM || InTexFormat == GpuFormat::B8G8R8A8_UNORM_SRGB;
	}
	...
	//	uint32 UnpaddedSize = InGpuTex->GetWidth() * InGpuTex->GetHeight() * GetFormatByteSize(InGpuTex->GetFormat());
 //       
 //       tarray<uint8> unpaddeddata;
 //       unpaddeddata.setnumuninitialized(unpaddedsize);
	//	uint32 unpaddedrowpitch = ingputex->getwidth() * getformatbytesize(ingputex->getformat());
