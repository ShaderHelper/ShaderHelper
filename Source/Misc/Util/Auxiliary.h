...
namespace SH {
	...
	template<typename Base, typename Target, uint8... Indexes>
	struct Swizzle 
	{
		...
		struct Op<TIntegerSequence<uint32, LeftIndexes...>,TIntegerSequence<uint32, RightIndexes...>> {
			static Target Sum(const Target& lhs, const Swizzle& rhs) { return Target(lhs[LeftIndexes]+rhs.Data[RightIndexes]...); }
			static Target Sum(const Swizzle& lhs, const Target& rhs) { return Target(lhs.Data[LeftIndexes]+rhs[RightIndexes]...); }
			static Target Mul(const Target& lhs, const Swizzle& rhs) { return Target(lhs[LeftIndexes] * rhs.Data[RightIndexes]...); }
			static Target Mul(const Swizzle& lhs, const Target& rhs) { return Target(lhs.Data[LeftIndexes] * rhs[RightIndexes]...); }
			static Target Sub(const Target& lhs, const Swizzle& rhs) { return Target(lhs[LeftIndexes] - rhs.Data[RightIndexes]...); }
			static Target Sub(const Swizzle& lhs, const Target& rhs) { return Target(lhs.Data[LeftIndexes] - rhs[RightIndexes]...); }
			static Target Div(const Target& lhs, const Swizzle& rhs) { return Target(lhs[LeftIndexes] / rhs.Data[RightIndexes]...); }
			static Target Div(const Swizzle& lhs, const Target& rhs) { return Target(lhs.Data[LeftIndexes] / rhs[RightIndexes]...); }
		};

		friend Target operator+(const Target& lhs, const Swizzle& rhs) {
			return Op<TMakeIntegerSequence<uint32, sizeof...(Indexes)>, TIntegerSequence<uint32, Indexes...>>::Sum(lhs, rhs);
		}
		friend Target operator*(const Target& lhs, const Swizzle& rhs) {
			return Op<TMakeIntegerSequence<uint32, sizeof...(Indexes)>, TIntegerSequence<uint32, Indexes...>>::Mul(lhs, rhs);
		}
		friend Target operator-(const Target& lhs, const Swizzle& rhs) {
			return Op<TMakeIntegerSequence<uint32, sizeof...(Indexes)>, TIntegerSequence<uint32, Indexes...>>::Sub(lhs, rhs);
		}
		friend Target operator/(const Target& lhs, const Swizzle& rhs) {
			return Op<TMakeIntegerSequence<uint32, sizeof...(Indexes)>, TIntegerSequence<uint32, Indexes...>>::Div(lhs, rhs);
		}

		friend Target operator+(const Swizzle& lhs, const Target& rhs) {
			return Op<TIntegerSequence<uint32, Indexes...>, TMakeIntegerSequence<uint32, sizeof...(Indexes)>>::Sum(lhs, rhs);
		}
		friend Target operator*(const Swizzle& lhs, const Target& rhs) {
			return Op<TIntegerSequence<uint32, Indexes...>, TMakeIntegerSequence<uint32, sizeof...(Indexes)>>::Mul(lhs, rhs);
		}
		friend Target operator-(const Swizzle& lhs, const Target& rhs) {
			return Op<TIntegerSequence<uint32, Indexes...>, TMakeIntegerSequence<uint32, sizeof...(Indexes)>>::Sub(lhs, rhs);
		}
		friend Target operator/(const Swizzle& lhs, const Target& rhs) {
			return Op<TIntegerSequence<uint32, Indexes...>, TMakeIntegerSequence<uint32, sizeof...(Indexes)>>::Div(lhs, rhs);
		}
