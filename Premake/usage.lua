...
---
-- Two stacks which stores actual oreder of projects and usages
...
--        name of usage
-- @param sourceName
--        name of project from where usage was use
---  
...
--
-- @param count
--        number of pops to do, if nil then 1 pop
---
...
--
-- @param targetProject
--		  project which contains targetBlock
-- @param targetBlock
--		  block where usage content will be copyed
-- @param usage
--        usage block
---
...
--
-- @param usesTable
--		  table where usageName is stored
-- @param usageName
--        name of usage to insert na push
-- @param sourceName
--        name of project from where usage was use
--
...
---
-- Run "bake" process on source project if need,
-- if "bake" on sourceProject is under way this mean that we have circular dependence
--
-- @param sourceProject
--		  project to "bake"
-- @param targetProject
--        project which call "bake" on sourceProject
--- 
...
---
	...
	local function resolveAllUsesInBlock( targetProject,
									targetBlock )		
